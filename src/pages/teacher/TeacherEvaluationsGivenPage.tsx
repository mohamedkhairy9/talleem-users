 ...
 */
const TeacherEvaluationsGivenPage: React.FC = () => {
    ...
    return (
        <div className="flex min-h-full flex-col space-y-6">
            <PageHeader
                title={t('evaluations.givenTitle', 'Given Evaluations')}
                subtitle={t('evaluations.givenSubtitle', 'Evaluations you have submitted')}
            />
