 ...
 */
const TeacherEvaluationsReceivedPage = () => {
    const { t } = useTranslation();
    return (<div className="flex min-h-full flex-col space-y-6">
            <PageHeader title={t('evaluations.receivedTitle', 'Received Evaluations')} subtitle={t('evaluations.receivedSubtitle', 'Evaluations others have given you')}/>
