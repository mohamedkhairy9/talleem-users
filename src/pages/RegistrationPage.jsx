...
const RegistrationPage = () => {
    ...
    return (<div dir={direction} className="min-h-screen bg-gradient-to-tr from-primary to-primary-900 relative overflow-hidden">
            {/* Background Pattern */}
            ...
            <div className="relative z-10 min-h-screen flex">
                ...
                <div className="flex-1 flex items-center lg:items-end justify-center px-8 py-8 lg:py-0">
                    <div className={`w-full max-w-7xl transition-all duration-1000 ease-out transform ${isVisible
            ? 'translate-y-0 opacity-100'
            : 'translate-y-full opacity-0'}`}>
                        {/* Logo for small screens */}
                        <div className="lg:hidden mb-6 flex justify-center">
                            <img src={logo} alt="Tallem Logo" className="h-20 object-contain"/>
                        </div>
                ...
                <div className="hidden lg:flex flex-1 justify-center px-8">
                    <div className={`text-center text-white transition-all duration-1000 ease-out transform ${isVisible
            ? 'translate-y-0 opacity-100'
            : '-translate-y-full opacity-0'}`}>
                        {/* Logo */}
                        <div className="mb-8">
                            <img src={logo} alt="Tallem Logo" className="mx-auto object-contain"/>
                        </div>
