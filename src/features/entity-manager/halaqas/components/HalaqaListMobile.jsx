            ...
            return (<div key={row.id} className="rounded-lg border border-gray-200 bg-white p-4 shadow-sm">
                    ...
                    '-'}
                        ...
                        <div className="mt-4 flex gap-2">
                            ...
                            <button type="button" onClick={() => onEdit(row.id)} className="flex flex-1 items-center justify-center gap-1.5 rounded-lg bg-gray-100 py-2.5 text-sm font-medium text-gray-700 transition-colors hover:bg-gray-200">
                                <EditIcon width={18} height={18}/>
                                {t('common.edit', 'Edit')}
                            </button>
                            <button type="button" onClick={() => onDelete(row.id)} disabled={isDeleting} className="flex items-center justify-center rounded-lg p-2.5 text-red-600 transition-colors hover:bg-red-50 disabled:opacity-50" aria-label={t('common.delete', 'Delete')}>
