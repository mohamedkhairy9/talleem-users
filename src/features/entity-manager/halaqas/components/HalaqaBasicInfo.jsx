...
const HalaqaBasicInfo = ({ name, teacher, entityType, period, teachingMethod, platform, getLocalizedText }) => {
    ...
    return (<div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                {teacher && (<div className="space-y-1">
                ...
                {entityType && (<div className="space-y-1">
                        <p className="text-xs font-medium text-gray-500 uppercase tracking-wide">
                            {t('halaqa.entityType')}
                        </p>
                ...
                {teachingMethod && (<div className="space-y-1">
                        <p className="text-xs font-medium text-gray-500 uppercase tracking-wide">
                            {t('halaqa.teachingMethod', 'Teaching Method')}
                        </p>
                        <p className="text-base font-medium text-gray-900">
                            {String(t(`halaqa.teachingMethod.${teachingMethod === 'in_person' ? 'inPerson' : teachingMethod}`, teachingMethod))}
                        </p>
                    </div>)}
                {platform && (<div className="space-y-1">
                        <p className="text-xs font-medium text-gray-500 uppercase tracking-wide">
