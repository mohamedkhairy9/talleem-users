...
const HalaqaStudents: React.FC<HalaqaStudentsProps> = ({
    students,
    onViewAll,
    onViewStudent,
    getLocalizedText
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                {displayStudents.map((student, index) => (
                    <div 
                        ...
                        className="p-4 bg-gradient-to-br from-gray-50 to-gray-100 rounded-lg border border-gray-200 hover:border-primary-300 transition-colors cursor-pointer"
