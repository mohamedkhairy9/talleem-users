...
const HalaqaPlansSection: React.FC<HalaqaPlansSectionProps> = ({
    plans,
    halaqaId,
    students,
    activities,
    ...
    return (
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            ...
            {showPlanForm && (
                <div className="mb-6 p-6 bg-gradient-to-br from-gray-50 to-gray-100 rounded-xl border-2 border-primary-200">
                    ...
                    {plans.map((plan, index) => {
                        ...
                        return (
                            <HalaqaPlanCard
                                ...
                                onViewStudents={() => onViewPlanStudents(plan)}
