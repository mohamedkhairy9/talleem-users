 ...
 */
const PlanStudentsModal = ({ isOpen, students, onClose, currentLang = 'ar' }) => {
    ...
    return (<div className="fixed inset-0 z-[60] overflow-y-auto">
            {/* Backdrop */}
            <div className="fixed inset-0 bg-black transition-opacity" style={{ opacity: 0.5 }} onClick={onClose} aria-hidden="true"/>
            ...
            <div className="relative flex min-h-full items-center justify-center p-4 pt-20 md:pt-24">
                <div className="relative w-full max-w-md transform overflow-hidden rounded-lg bg-white shadow-xl transition-all z-10 max-h-[calc(100vh-5rem)] md:max-h-[calc(100vh-6rem)]">
                    ...
                    <div className="px-6 py-4 max-h-[calc(100vh-12rem)] md:max-h-[calc(100vh-14rem)] overflow-y-auto">
                        {students.length > 0 ? (<div className="space-y-3">
                                {students.map((student, index) => (<div key={student.id || index} className="p-4 bg-gray-50 rounded-lg border border-gray-200 hover:border-primary-300 transition-colors">
                                        <div className="flex items-start justify-between">
                                            ...
                                            {student.id && (<div className="ml-4 text-xs text-gray-400">
