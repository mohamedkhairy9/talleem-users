...
const JoinRequestsList = () => {
    ...
    const columns = useMemo(() => createJoinRequestsColumns({
        ...
        lang: currentLang
    }), [t, getLocalizedTextForRow, currentLang]);
    ...
    return (<div className="flex flex-col flex-1 min-h-0 overflow-hidden">
                ...
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
                    <div>
                        ...
                        <div className="relative min-h-[48px]">
                            ...
                            <input type="text" placeholder={t('joinRequests.searchPlaceholder')} value={localSearch} onChange={(e) => setLocalSearch(e.target.value)} className="h-[48px] w-full rounded-lg border border-gray-300 bg-white ps-10 pe-3 text-sm outline-none focus:border-primary-500 focus:ring-1 focus:ring-primary-500"/>
                        </div>
                    </div>
                    <div className="flex items-end">
                        <Button type="button" variant="outline" onClick={resetFilters} disabled={!hasActiveFilters} className="inline-flex items-center gap-2">
            ...
            onView: handleView
                ...
                {totalPages > 1 && (<div className="flex-shrink-0 border-t border-gray-200 px-4 py-3">
                        <Pagination currentPage={currentPage} totalPages={totalPages} total={total} onPageChange={setPage} perPage={perPage}/>
                    </div>)}
            </div>
