 ...
 */
const RoleSelection = ({ onSelectRole, onCheckStatus }) => {
    ...
    return (<div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {roles.map((role) => (<button key={role.type} type="button" onClick={() => onSelectRole(role.type)} className="p-6 border-2 border-gray-200 rounded-xl hover:border-primary-600 hover:bg-primary-50 transition-all duration-200 text-center group">
            ...
            <div className="mt-8 text-center space-y-3">
                <Button type="button" variant="secondary" onClick={onCheckStatus} className="w-full md:w-auto">
