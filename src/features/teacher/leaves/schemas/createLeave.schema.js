...
export const createLeaveFormSchema = yup.object({
    ...
    medical_report: yup
        ...
        is: (leave_type, leave_sub_type) => leave_type === 'leave' && leave_sub_type === 'sick',
        then: (schema) => schema.test('medical-report-required', 'medicalReportRequired', (value) => value != null && value instanceof File && value.size > 0),
