...
const TeacherLeavesList: React.FC = () => {
    ...
    const handleCancel = useCallback((item: TeacherLeaveItem) => {
    ...
    const columns = useMemo(
        () => createTeacherLeavesListColumns({ t, onCancel: handleCancel, isCancellingId: cancellingId }),
        [t, handleCancel, cancellingId]
    );
        ...
        <div className="flex flex-col flex-1 min-h-0 overflow-hidden">
            <div className="flex flex-1 flex-col overflow-hidden md:hidden min-h-[280px] bg-white rounded-lg">
                <div className="flex-1 min-h-0 overflow-y-auto overflow-x-hidden">
                    <TeacherLeavesListMobile
                        list={list}
                        isLoading={isLoading}
                        hasError={!!error}
                        errorMessage={error ? t('leaves.loadError') : undefined}
                        emptyMessage={t('leaves.noLeaves', 'No leaves yet.')}
