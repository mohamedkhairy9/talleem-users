...
interface TeacherLicensesListMobileProps {
    list: TeacherLicenseItem[];
    isLoading: boolean;
    hasError: boolean;
    errorMessage?: string;
    emptyMessage: string;
...
const TeacherLicensesListMobile: React.FC<TeacherLicensesListMobileProps> = ({
    list,
    isLoading,
    hasError,
    errorMessage,
...
export default TeacherLicensesListMobile;
