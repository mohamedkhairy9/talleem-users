 ...
 */
const GivenEvaluationsList: React.FC = () => {
    ...
    const columns = useMemo(
        () => createGivenEvaluationsListColumns({ t, getLocalizedText }),
        [t, getLocalizedText]
    );
        ...
        <div className="flex flex-col flex-1 min-h-0 overflow-hidden">
            <div className="flex flex-1 flex-col overflow-hidden md:hidden min-h-[280px] bg-white rounded-lg">
                <div className="flex-1 min-h-0 overflow-y-auto overflow-x-hidden">
                    <GivenEvaluationsListMobile
                        list={list}
                        isLoading={isLoading}
                        hasError={!!error}
                        errorMessage={error ? t('evaluations.loadError', 'Error loading evaluations.') : undefined}
                        emptyMessage={t('evaluations.noGivenEvaluations', 'No evaluations submitted yet.')}
