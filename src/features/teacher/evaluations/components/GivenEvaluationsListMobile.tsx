...
import type { GivenEvaluationItem } from '../types/evaluations.types';
import { getDisplayDate } from '@/utils';
import { useDateFormatStore } from '@/stores';

interface GivenEvaluationsListMobileProps {
    list: GivenEvaluationItem[];
    isLoading: boolean;
    hasError: boolean;
    errorMessage?: string;
    emptyMessage: string;
...
const GivenEvaluationsListMobile: React.FC<GivenEvaluationsListMobileProps> = ({
    list,
    isLoading,
    hasError,
    errorMessage,
    ...
    const formatDate = (row: GivenEvaluationItem) => {
...
export default GivenEvaluationsListMobile;
