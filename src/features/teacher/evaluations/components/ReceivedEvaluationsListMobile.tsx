...
import type { ReceivedEvaluationItem } from '../types/evaluations.types';
import { getDisplayDate } from '@/utils';
import { useDateFormatStore } from '@/stores';

interface ReceivedEvaluationsListMobileProps {
    list: ReceivedEvaluationItem[];
    isLoading: boolean;
    hasError: boolean;
    errorMessage?: string;
    emptyMessage: string;
...
const ReceivedEvaluationsListMobile: React.FC<ReceivedEvaluationsListMobileProps> = ({
    list,
    isLoading,
    hasError,
    errorMessage,
    ...
    const formatDate = (row: ReceivedEvaluationItem) => {
