...
const TeacherWarningsList = () => {
    ...
    const columns = useMemo(() => createTeacherWarningsListColumns({ t, getLocalizedText }), [t, currentLang]);
    ...
    return (<div className="flex flex-col flex-1 min-h-0 overflow-hidden">
            ...
            <div className="flex flex-1 flex-col overflow-hidden md:hidden min-h-[280px] bg-white rounded-lg">
                <div className="flex-1 min-h-0 overflow-y-auto overflow-x-hidden">
                    <TeacherWarningsListMobile list={list} isLoading={isLoading} hasError={!!error} errorMessage={error ? t('warning.loadError', 'Error loading warnings.') : undefined} emptyMessage={t('warning.noWarnings', 'No warnings found')} getLocalizedText={getLocalizedText}/>
                </div>
            ...
            <div className="hidden md:flex flex-col flex-1 min-h-0 overflow-hidden">
                <div className="flex-1 min-h-0 overflow-hidden">
                    <Table columns={columns} data={list} loading={isLoading} emptyMessage={t('warning.noWarnings', 'No warnings found')} scrollable/>
                </div>
