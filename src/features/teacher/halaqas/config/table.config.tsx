...
import type { TeacherHalaqaItem } from '../types/list.types';
...
export const createTeacherHalaqaListColumns = (params: {
    ...
    return [
        ...
        },
        {
            ...
            accessor: (row) => formatDate(row.halaqa.start_date)
        },
        {
            header: t('halaqa.endDate', 'End Date'),
            accessor: (row) => formatDate(row.halaqa.end_date)
        },
        {
        ...
        },
        {
            ...
            accessor: (row) => {
                if (!row.halaqa.teaching_method) return '-';
        ...
        },
        {
            ...
            accessor: (row) =>
                row.halaqa.current_students_count ?? row.halaqa.students?.length ?? row.halaqa.max_students ?? '-'
        },
        {
