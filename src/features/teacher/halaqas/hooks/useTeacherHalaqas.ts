...
import type { TeacherHalaqasListResponse, TeacherHalaqaItem } from '../types/list.types';
...
export const useTeacherHalaqas = () => {
    ...
    const responseBody = query.data as TeacherHalaqasListResponse | undefined;
    const list: TeacherHalaqaItem[] = Array.isArray(responseBody?.data) ? responseBody.data : [];
